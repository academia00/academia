...
const FeatureTwo = () => {
  return (
    <>
      <section className="features-section-two pt-5 mt-5">
        ...
        <div className="auto-container">
          ...
          <div className="row">
            ...
            <div className="feature-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
              <div className="inner-box ">
                <figure className="image">
                  <img src="images/resource/feature-1.png" title="Edulrns" />
                </figure>
                <h4 className="title">
                  <Link href="/page-about">26+ courses</Link>
                </h4>
                <div className="text">
            ...
            >
              <div className="inner-box ">
                <figure className="image">
                  <img src="images/resource/feature-2.png" title="Edulrns" />
                </figure>
                <h4 className="title">
                  <Link href="/page-about">Industry instructors</Link>
                </h4>
                <div className="text">
                  Whether you want to learn or to share what you know, you’ve
                  come to the right place.
            ...
            >
              <div className="inner-box ">
                <figure className="image">
                  <img src="images/resource/feature-3.png" title="Edulrns" />
                </figure>
                <h4 className="title">
                  <Link href="/page-about">Lifetime access</Link>
                </h4>
                <div className="text">
                  Whether you want to learn or to share what you know, you’ve
                  come to the right place.
